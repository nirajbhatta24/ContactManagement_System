...
def Login():
    if Username.get()=="niraj" and Password.get()=="1234":
        mainpage()
    else:
...
def mainpage():
    ...
    def DisplayForm():
        ...
        display_screen.iconbitmap('icon.ico')
        global tree
        global SEARCH
        ...
        #label for heading
        lbl_text = Label(TopViewForm, text="Contact Management System", font=('verdana', 18), width=600,bg="light green")
        ...
        destroy = Button(display_screen, text="Destroy this Window", bg="red", command=display_screen.destroy)
        destroy.place(x=700, y=400)
        ...
        btn_search = Button(LeftViewForm, text="Search", command=SearchRecord,bg="light green")
        btn_search.pack(side=TOP, padx=10, pady=10, fill=X)
        #creating view button
        btn_view = Button(LeftViewForm, text="View All", command=DisplayData,bg="light green")
        btn_view.pack(side=TOP, padx=10, pady=10, fill=X)
        #creating reset button
        btn_reset = Button(LeftViewForm, text="Reset", command=Reset,bg="light green")
        btn_reset.pack(side=TOP, padx=10, pady=10, fill=X)
        #creating delete button
        btn_delete = Button(LeftViewForm, text="Delete", command=Delete,bg="light green")
        btn_delete.pack(side=TOP, padx=10, pady=10, fill=X)
        #create update button
        btn_delete = Button(LeftViewForm, text="Update", command=Update,bg="light green")
        btn_delete.pack(side=TOP, padx=10, pady=10, fill=X)
        #setting scrollbar
    ...
    def Update():
        ...
        if fname1=='' or lname1==''or gender1=='' or address1==''or contact1=='':
            tkMessageBox.showinfo("Warning","fill the empty field!!!", parent=display_screen)
        else:
